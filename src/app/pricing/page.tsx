        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-24">
            <div className="relative inline-block">
              <div className="absolute -inset-px bg-gradient-to-r from-blue-500 to-purple-500 blur-xl opacity-10 rounded-3xl" />
            ...
            {ENTERPRISE_FEATURES.map((feature) => (
              ...
              >
                <div className="relative">
                  <div className="size-12 rounded-xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 flex items-center justify-center mb-4 ring-1 ring-gray-800/60 group-hover:ring-blue-500/20">
              ...
              <div className="relative p-8 md:p-12">
                ...
                <div className="grid md:grid-cols-3 gap-12 mb-12">
                  {Object.entries(FEATURES).map(([category, features]) => (
                    <FeatureCategory key={category} label={category}>
