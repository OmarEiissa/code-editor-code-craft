  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className={`group relative flex items-center gap-1 lg:gap-2 px-1.5 sm:px-2.5 lg:px-4 py-1 sm:py-1.5 lg:py-2.5 bg-[#1e1e2e]/80 rounded-lg transition-all duration-200 border border-gray-800/50 hover:border-gray-700 outline-none ${
      ...
      <AnimatePresence initial={false}>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full right-1/2 max-lg:!translate-x-1/2 lg:left-0 mt-2 w-64 bg-[#1e1e2e]/95 backdrop-blur-xl rounded-xl border border-[#313244] shadow-2xl py-2 z-50"
          >
            <div className="px-3 pb-2 mb-2 border-b border-gray-800/50">
              <p className="text-xs font-medium text-gray-400 text-center lg:text-left">
                Select Language
              </p>
            </div>
